...
/** The pixel-asterisk Aster mark as inline SVG. `px` is the size of one cell,
    so the mark renders at `13 * px` square. With `interactive`, clicking it
    plays a single snappy spin. */
